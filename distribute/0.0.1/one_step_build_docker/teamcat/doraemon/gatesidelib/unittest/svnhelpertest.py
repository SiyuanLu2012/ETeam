...
#         svn_helper=SvnHelper('https://svn.sys.com/branches/sdk3.7','auto','fdsa')
#         print(svn_helper.get_allcodelines('7966'))
#     
#     def test_get_newcodelines(self):
#         svn_helper=SvnHelper('https://svn.sy/branches/sdk3.7','auto','fsdafds.2')
#         print(svn_helper.get_newcode_lines('7000','7966'))
#         
#     def test_get_deletecodelines(self):
#         svn_helper=SvnHelper('https://svn/branches/sdk3.7','auto','fdsfdsfds')
#         print(svn_helper.get_deletecode_lines('7000','7966'))
#     
#     def test_get_commit_log(self):
#         svn_helper=SvnHelper('https://svn.sys.branches/sdk3.7','autotfdsfdsest','fsdfsdfds','d:\\gateside.log')
...
#         os.system('cd "e:\\dushubus" & git pull --username fdsafasd --password Nfsdfds >> git5.log')
        
#     def test2(self):
#         svn_helper=SvnHelper('https://svn.sys/sdk3.7','autotest','opafsafdsss.2','d:\\gateside.log')
